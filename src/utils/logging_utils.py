...
def log_hyperparameters(object_dict: Dict[str, Any]) -> None:
    ...
    for logger in trainer.loggers:
        if isinstance(logger, WandbLogger):  # Exception when updating _wandb_init directly, do this instead
            logger.experiment.config.update(hparams, allow_val_change=True)
        else:
